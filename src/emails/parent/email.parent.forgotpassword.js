  ...
  <div style="width: 100%; background-color: #eef4f9; padding: 40px 0;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; border: 1px solid #ced3f1;">
      <div style="background-color: #ffffff; padding: 30px 40px 10px 40px; text-align: center;">
        ...
        <h2 style="color: #1e1e2d; margin-bottom: 10px; margin-top: 0;">Reset Your Password</h2>
        <p style="color: #6d6d76; font-size: 16px; line-height: 1.5;">
          Hello ${name}! We have received a request to reset your StudyScope Tutoring account password. Click the button below to proceed.
        </p>
        <a href="${resetLink}" style="display: inline-block; background: radial-gradient(100% 100% at 50% 0%, #a225eb 0%, #4319db 100%); color: #ffffff; text-decoration: none; font-weight: bold; padding: 14px 28px; border-radius: 5px; font-size: 16px;">
          Reset Password
        </a>
